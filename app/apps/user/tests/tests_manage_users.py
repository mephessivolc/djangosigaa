...
class UsersManagersTests(TestCase):
    ...
    def test_create_superuser(self):
        User = get_user_model()
        admin_user = User.objects.create_superuser(email="super@user.com", username="normal", password="foo")
        ...
        with self.assertRaises(ValueError):
            User.objects.create_superuser(
                email="super@user.com", username='normal', password="foo", is_superuser=False)
