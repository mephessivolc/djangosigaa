...
EMAIL_HOST = config("EMAIL_BACKEND", default='')
EMAIL_HOST_USER = config("EMAIL_BACKEND", default='')
EMAIL_HOST_PASSWORD = config("EMAIL_BACKEND", default='')
DEFAULT_FROM_EMAIL = config("EMAIL_BACKEND", default='')
